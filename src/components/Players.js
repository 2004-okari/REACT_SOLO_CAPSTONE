        ...
        <div className="team-div">
          ...
          <div className="content-div">
            ...
            <div className="info-div">
              ...
              <div className="boxes">
                Teams Website:
                <a target="blank" className="span-text" style={{ color: 'red' }} href={team?.strWebsite}>{team.strTeam}</a>
              </div>
              <div className="boxes">
                Teams Facebook:
                <a target="blank" className="span-text" style={{ color: 'red' }} href={team?.strFacebook}>{team.strTeam}</a>
              </div>
              <div className="boxes">
                Teams Twitter:
                <a target="blank" className="span-text" style={{ color: 'red' }} href={team?.strTwitter}>{team.strTeam}</a>
              </div>
              <div className="boxes">
                Teams Instagram:
                <a target="blank" className="span-text" style={{ color: 'red' }} href={team?.strInstagram}>{team.strTeam}</a>
              </div>
            </div>
          </div>
        </div>
